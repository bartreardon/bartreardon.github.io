...
Two days later on the 11th March 2021 the first beta version was released on GitHub as a binary and the following day [I wrote a blog]({{ "/2021/03/11/dialog-an-app-for-showing-a-dialog.html" | relative_url }}) post announcing it. The source was released on the 20th after clearance from my employer.
...
![The Dialog Version 0.2.1 about window](/images/dialog-6-months-later-screen-shot-2021-09-21-at-10.44.56-pm.png)
...
![A collage of Dialog windows showing various features including update prompts, custom fields, a timer, and a list selector](/images/dialog-6-months-later-screen-shot-2021-09-21-at-11.21.15-pm.png)
